    ...
    <>
      <div className={classes.who} id="who">
        ...
        <h3 className={classes.subTitle}>
          Martinu&lsquo;s Man Elende,<br></br>
          association à but non lucratif
        </h3>
        <p className={classes.body}>
          Association Loi 1901, Martinu’s Man-Elende a pour objectif d’encourager l’éducation dans une école primaire de
          Leyong,
          ...
          . La création de cette association me paraissait évidente. Originaire du Cameroun, j’ai très vite compris que
          la réussite professionnelle passait par une éducation solide. La réflexion s’est poursuivie lors d’un retour
        ...
        <p className={classes.signature}>
          - Martin ATANGANA<br></br>Président de l&lsquo;association
        </p>
      </div>
    </>
  );
